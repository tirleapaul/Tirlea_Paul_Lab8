...
namespace Tirlea_Paul_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Tirlea_Paul_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Tirlea_Paul_Lab8Context context,
